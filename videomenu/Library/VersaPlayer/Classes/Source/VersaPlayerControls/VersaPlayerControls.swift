...
open class VersaPlayerControls: View {
  ...
  @IBOutlet public weak var airplayContainer: UIView?
  #endif
  ...
  @IBOutlet public weak var bufferingView: View?
  ...
  public var isMuted = true {
    didSet {
      handler.player.isMuted = self.isMuted
    }
  }
  ...
  private func checkOwnershipOf(object: Any?, completion: @autoclosure () -> Void?) {
